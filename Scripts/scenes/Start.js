...
(function (scenes) {
    var Start = /** @class */ (function (_super) {
        ...
        Start.prototype.Start = function () {
            ...
            this._isPlayingCheckBox = new ui.CheckBox(14, config.Colour.BLACK, config.Colour.DARK_GREY, new util.Vector2(10 + this._isPlayingLabel.getBounds().width + 5, 360), false);
